...
if (mobileSoundToggle) {
    mobileSoundToggle.addEventListener('click', () => {
        ...
        if(isSoundOn) {
            ...
            mobileSoundToggle.classList.add('bg-sa-silver', 'text-sa-black');
            mobileSoundToggle.classList.remove('bg-transparent', 'text-sa-silver');
            if(soundToggle) {
                soundToggle.textContent = 'Sound: On';
                soundToggle.classList.add('bg-sa-silver', 'text-sa-black');
                soundToggle.classList.remove('bg-transparent', 'text-sa-silver');
            ...
            mobileSoundToggle.classList.remove('bg-sa-silver', 'text-sa-black');
            mobileSoundToggle.classList.add('bg-transparent', 'text-sa-silver');
            if(soundToggle) {
                soundToggle.textContent = 'Sound: Off';
                soundToggle.classList.remove('bg-sa-silver', 'text-sa-black');
                soundToggle.classList.add('bg-transparent', 'text-sa-silver');
...
// mobile menu is handled in transition.js
